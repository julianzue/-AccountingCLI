...
try:
    ...
    quest = input("[+] Would you like to install it? [Y|n]: ")

    if quest == "" or quest == "y" or quest == "Y":
...
class Buchhaltung():
    ...
    def change(self):
        ...
        print(c + "[*] " + R + "Successfully change line " + c + "{:03d}".format(int(number)) + R + " of " + c + filename + R + ".")
    ...
    def remove(self):
        ...
        print(c + "[*] " + R + "Successfully removed line " + c + "{:03d}".format(int(number)) + R + " of " + c + filename + R + ".")
